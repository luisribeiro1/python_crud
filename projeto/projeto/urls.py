...
urlpatterns = [
    ...
    path('novo/', criar_usuario, name='rotaNovoUsuario'),
    path('editar/<int:id>/', editar_usuario, name='rotaEditarUsuario'),
    path('excluir/<int:id>/', excluir_usuario, name='rotaExcluirUsuario'),
]
